...
target <- args[1] # name of target
rnd <- as.numeric(args[2])  # round (1 for tuning, 2 for final)
ii <- as.numeric(args[3])  # job id
...
load(paste0("input/schedule_target", target, "_round", rnd, ".rda"))
