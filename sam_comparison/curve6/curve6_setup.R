...
w <- c(0.1, 0.4, 0.6, 0.8, 1)#c(0.01, 1, 2, 4, 10)
...
mu <- c(0.2,0.5,0.8)#c(1,2,3,4.5,6,7)
...
log_pdf <- c(function(x) dbeta(x, shape1 = 0.3, shape2 = 0.7, log = TRUE),
             ...
             function(x) dbeta(x, shape1 = 5/3, shape2 = 5/4, log = TRUE),
             function(x) dbeta(x, shape1 = 0.1, shape2 = 0.9, log = TRUE),
             function(x) dbeta(x, shape1 = 0.2, shape2 = 0.8, log = TRUE),
             function(x) dbeta(x, shape1 = 1.1, shape2 = 1, log = TRUE),
             function(x) dbeta(x, shape1 = 1, shape2 = 1.1, log = TRUE),
             function(x) dbeta(x, shape1 = 0.4, shape2 = 0.6, log = TRUE),
...
inv_cdf <- c(function(u) qbeta(u, shape1 = 0.3, shape2 = 0.7),
             ...
             function(u) qbeta(u, shape1 = 5/3, shape2 = 5/4),
             function(u) qbeta(u, shape1 = 0.1, shape2 = 0.9),
             function(u) qbeta(u, shape1 = 0.2, shape2 = 0.8),
             function(u) qbeta(u, shape1 = 1.1, shape2 = 1),
             function(u) qbeta(u, shape1 = 1, shape2 = 1.1),
             function(u) qbeta(u, shape1 = 0.4, shape2 = 0.6),
             function(u) qbeta(u, shape1 = 2, shape2 = 2)
             )

## rand walk tuning parameter ##
c <- c(0.1,0.3,0.5,0.7,1)
