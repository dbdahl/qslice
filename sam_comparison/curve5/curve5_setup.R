...
log_pdf <- c(function(x) dt(x, df = 2, log = TRUE),
             ...
             function(x) dnorm(x, mean = 2, sd = 8, log = TRUE),
             function(x) dnorm(x, mean = 2, sd = 10, log = TRUE),
             function(x) dnorm(x, mean = 0, sd = 10, log = TRUE),
             function(x) dnorm(x, mean = 5, sd = 15, log = TRUE),
             function(x) dnorm(x, mean = -5, sd = 10, log = TRUE),
...
inv_cdf <- c(function(u) qt(u, df = 2),
             ...
             function(u) qnorm(u, mean = 2, sd = 8),
             function(u) qnorm(u, mean = 2, sd = 10),
             function(u) qnorm(u, mean = 0, sd = 10),
             function(u) qnorm(u, mean = 5, sd = 15),
             function(u) qnorm(u, mean = -5, sd = 10),
