...
py <- 0.2 * dnorm(grid, sd = 0.5) + 0.8 * dnorm(grid, mean = 20, sd = 1)
...
log_pdf <- c(
  'dnorm(x, mean = 10, sd = 10, log = TRUE)',
  'dnorm(x, mean = 0, sd = 20, log = TRUE)',
  'dnorm(x, mean = 20, sd = 20, log = TRUE)'
)

inv_cdf <- c('qnorm(u, mean = 10, sd = 10)',
             'qnorm(u, mean = 0, sd = 20)',
             'qnorm(u, mean = 20, sd = 20)')

find_grid <- c('seq(from = qnorm((1-.99999)/2, mean = 10, sd = 10),
