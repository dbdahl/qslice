...
dte <- 260518
dte <- 260520 # includes regression based pseudo-targets
dte <- 260521 # further refined reg pseudos
data_now <- "db40"
data_now <- "db"

files_all <- list.files("output")
files_use <- files_all[grep(paste0(data_now, "_.*_dte", dte), x = files_all)]
